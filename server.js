...
app.get('/feed', function(req, res) {
  ...
  var tomorrow = db.query('SELECT * FROM events WHERE startDate >= TIMESTAMP \'tomorrow\' AND startDate < TIMESTAMP \'tomorrow\' AT TIME ZONE \'EST\' + interval \'1 day\' ORDER BY startDate ASC');
