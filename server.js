...
app.get('/feed', function(req, res) {
  console.log("FEED");
  var today = db.query('SELECT * FROM events');// WHERE startDate > TIMESTAMP \'today\'');// AND startDate < TIMESTAMP \'tomorrow\' + interval \'4 hours\' ORDER BY startDate ASC');
  var tomorrow = db.query('SELECT * FROM events WHERE startDate >= TIMESTAMP \'tomorrow\' AND startDate < TIMESTAMP \'tomorrow\' + interval \'1 day\' ORDER BY startDate ASC');
